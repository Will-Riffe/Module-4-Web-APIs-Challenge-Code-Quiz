...
function startQuiz() {
    ...
    function showScore() {
        ...
        form.addEventListener("submit", function (event) {
            ...
            // creates a new HTML element to display the initials and score
            const initialsElement = document.createElement("p");
            initialsElement.textContent = `${initials} - ${score}`;
            scoreElement.appendChild(initialsElement);
        });
        
        // handles the initials input (e.g. save to localStorage, update high scores)
        scoreElement.appendChild(form);

        // creates a label and input field for the initials
        ...
        submitButton.classList.add("d-flex", "flex-column", "btn-primary"); // fixed line
        submitButton.textContent = "Submit Score";
        form.appendChild(submitButton);

        // create a button to restart the quiz
        const restartButton = document.createElement("button");
        restartButton.classList.add("d-flex", "flex-column", "btn-primary"); // fixed line
